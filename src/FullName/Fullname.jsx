...
function Fullname() {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <input type="text" id="firstName" onChange={(e) => {setFirstName(e.target.value)}} pattern="[A-Za-z]+$" value={firstName} required/> {/* */}
      <br/>
      <label htmlFor="lastName">Last Name:</label> {/* The htmlFor prop in JSX is the same as the for attribute in HTML */}
      <input type="text" id="lastName" onChange={(e) => {setLastName(e.target.value)}} pattern="[A-Za-z]+$" value={lastName} required/>
      <br/>
